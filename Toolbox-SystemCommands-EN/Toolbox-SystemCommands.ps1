...
.NOTES
    ...
    -Verb RunAs) to actually run the script elevated, and that Start-Process
    call was missing -WindowStyle Hidden of its own, so the elevated Windows
    PowerShell 5.1 window it opened stayed visible behind the toolbox for the
    rest of the session. Not reproducible via right-click "Run as
    ...
    two launch methods behave differently. Fixed by adding -WindowStyle Hidden
    to that Start-Process call as well.
#>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAGEsVORsEbCgn8
# EQG6DfwA0CHd9f4aBX8QiZ9YjUcLn6CCAygwggMkMIICDKADAgECAhB6X4r8AlBU
...
# ARUwLwYJKoZIhvcNAQkEMSIEIK2v2mBONjiwRW2+WuBz8+jGHvP/GDAKyZP/ZfHl
# kfEuMA0GCSqGSIb3DQEBAQUABIIBACT0PMW1Jy1m7n+upkPXnxkv/wV/9XZGZUiF
# vBqbiwAGb6/bQUhvJUOTaqfXiyT4PDawcEKLV8yYeysO/z1VaESVqfaZP7FXqqAw
# ygbbVY1bq7v2rrokgl9MbSmO3tifWcIxC1GkdfGNXlwUN1MHBQrgagW5EVsX48Ec
# EhUO1Ii+2bu7D0PbVMxZDit+qodj1L9i191rVhukF0GAAeCsgHhPoDXZf8SjYHGz
# 5a58EjnPYR/Ldp+T7KTzKUlGAk7MXMyUoDSzdy8PxdOhDFUZSvI16XqTmyjtfxg9
# AZvG4OArFcdGtElEXp+EQZV9ftSrcmbiaVO+oBj7SnsQga1acpg=
