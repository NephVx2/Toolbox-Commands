        ...
        @{
            ...
            Commands = @(
                ...
                @{ Label = "Etat Secure Boot / TPM"
                   ...
                   Desc  = "Verifie rapidement l'etat de Secure Boot et du TPM sans lancer tout Check-Security. Message clair si la machine est en BIOS Legacy plutot qu'une erreur bloquante (Confirm-SecureBootUEFI echoue sur un systeme non-UEFI). Sur ce GL753VD, TpmPresent = False est attendu et deja documente (absence structurelle de TPM, meme cause que le FAIL BitLocker visible dans Check-Security)."
                   Confirm = $false }
        ...
        @{
            ...
            Commands = @(
                ...
                @{ Label = "Version PowerShell active"
                   ...
                   Desc  = "Affiche la version exacte de PowerShell resolue par 'powershell.exe' sur cette machine, plus le chemin complet de l'executable utilise. Utile pour verifier rapidement si powershell.exe pointe vers PowerShell 7 ou Windows PowerShell 5.1 natif (les deux peuvent coexister selon le PATH - cas deja observe sur cette machine)."
                   Confirm = $false }
