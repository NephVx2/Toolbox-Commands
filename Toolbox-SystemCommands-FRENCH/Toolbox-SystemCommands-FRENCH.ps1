...
.NOTES
    ...
    (powershell.exe -Verb RunAs) pour reellement executer le script en eleve, et cet
    appel Start-Process n'avait pas son propre -WindowStyle Hidden, donc la fenetre
    Windows PowerShell 5.1 elevee qu'il ouvrait restait visible derriere la toolbox
    pour le reste de la session. Non reproductible via clic droit "Executer en tant
    qu'administrateur" sur le raccourci, puisque le processus est deja eleve dans ce
    cas et que ce second lancement n'a jamais lieu - ce qui expliquait la difference de
    comportement entre les deux methodes de lancement. Corrige en ajoutant -WindowStyle
    Hidden a cet appel Start-Process egalement.
#>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCztkl9JaTEqsjr
# /b6jl6ZnYCjSqHlTaouQTD8d3CVpyKCCAygwggMkMIICDKADAgECAhB6X4r8AlBU
...
# ARUwLwYJKoZIhvcNAQkEMSIEIEHYH6p+xpLInNWjW6+E3FJrGgMRrGJF9kwIEEQf
# LvlzMA0GCSqGSIb3DQEBAQUABIIBAAlwgIxFHxRJ8Z2CGicVdlWiUZKRK4gfZ8k5
# hxHid+vZOhD/O4hV0+IIQTvW1k3eoPCY/4r76uSvnHQdfm27ASI3+fLV/3+B5vWX
# f9ECY2Fb+KjhMJDxIY5dmesZcFb4ifeUmsZGEqZZ7uPziAJfc5B0Zd+Ny7UpUHuC
# LI2AWCJcrtLhwfyZwOcHzRgagKm75Fagiv1RmLYVxFVrpeCNXtFn4CvN6X6i8dgD
# lKjr3WCd2x57ot+Lm/7uDHxZxPTtIVoic1Wva3vrumDh3IbFAmn9Bi/dZ1t1TSG4
# 4K5L+IinMGDRpiUE0smtWq7Vu777iQFOE/TGPwabZQau55kZvgY=
